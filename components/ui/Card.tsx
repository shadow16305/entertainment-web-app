...
const Card: React.FC<Props> = ({ ...props }) => {
  return (
    <Link href={`${props.link}`} className="flex flex-col mt-6 gap-y-2 hover:cursor-pointer">
      <div className="h-auto relative max-w-[160px] lg:max-w-[230px] 2xl:max-w-none w-full">
        <Image
